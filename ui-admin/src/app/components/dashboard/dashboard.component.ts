...
export class DashboardComponent {
  dashboardCards = [
    ...
    { title: 'Cart', description: 'Shopping cart', icon: 'add_shopping_cart', route: '/cart' },
    { title: 'Payments', description: 'View payments', icon: 'payment', route: '/payments' },
    { title: 'Inventory', description: 'Stock levels', icon: 'warehouse', route: '/inventory' },
    ...
    { title: 'Notifications', description: 'View notifications', icon: 'notifications', route: '/notifications' }
  ];
